 ...
 * 
 */
public class EcpprimerEditorMessages extends NLS {
	
	private static final String BUNDLE_NAME = "com.misc.touse.ecp.ecpprimer.providers.ecpprimerEditorMessages"; //$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, EcpprimerEditorMessages.class);
	}

	
	private EcpprimerEditorMessages() {
