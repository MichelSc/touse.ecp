...
/**
 * This is the item provider adapter for a {@link com.misc.touse.ecp.ecpprimer.Plan} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlanItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EcpPrimerPackage.Literals.PLAN__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EcpPrimerPackage.Literals.PLAN__ORDERS);
			childrenFeatures.add(EcpPrimerPackage.Literals.PLAN__RESOURCES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EcpPrimerPackage.Literals.PLAN__ORDERS,
				 EcpPrimerFactory.eINSTANCE.createOrder()));

		newChildDescriptors.add
			(createChildParameter
				(EcpPrimerPackage.Literals.PLAN__RESOURCES,
				 EcpPrimerFactory.eINSTANCE.createResourceAvailable()));
	}
