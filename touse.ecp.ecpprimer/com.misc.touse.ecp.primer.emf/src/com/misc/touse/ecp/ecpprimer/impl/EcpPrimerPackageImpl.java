...
import com.misc.touse.ecp.ecpprimer.OrderProduct;
 ...
 * @generated
 */
public class EcpPrimerPackageImpl extends EPackageImpl implements EcpPrimerPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.misc.touse.ecp.ecpprimer.EcpPrimerPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private EcpPrimerPackageImpl() {
		super(eNS_URI, EcpPrimerFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link EcpPrimerPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static EcpPrimerPackage init() {
		if (isInited) return (EcpPrimerPackage)EPackage.Registry.INSTANCE.getEPackage(EcpPrimerPackage.eNS_URI);

		// Obtain or create and register package
		EcpPrimerPackageImpl theEcpPrimerPackage = (EcpPrimerPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EcpPrimerPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new EcpPrimerPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theEcpPrimerPackage.createPackageContents();

		// Initialize created meta-data
		theEcpPrimerPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theEcpPrimerPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(EcpPrimerPackage.eNS_URI, theEcpPrimerPackage);
		return theEcpPrimerPackage;
	}
	 ...
	 * @generated
	 */
	public EcpPrimerFactory getEcpPrimerFactory() {
		return (EcpPrimerFactory)getEFactoryInstance();
	}
