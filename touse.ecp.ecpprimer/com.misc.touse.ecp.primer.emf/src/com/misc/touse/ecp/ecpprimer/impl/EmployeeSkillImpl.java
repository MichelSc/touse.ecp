 ...
 * </p>
 * <ul>
 *   <li>{@link com.misc.touse.ecp.ecpprimer.impl.EmployeeSkillImpl#getLevel <em>Level</em>}</li>
 *   <li>{@link com.misc.touse.ecp.ecpprimer.impl.EmployeeSkillImpl#getSkill <em>Skill</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EmployeeSkillImpl extends MinimalEObjectImpl.Container implements EmployeeSkill {
	...
	protected EClass eStaticClass() {
		return EcpPrimerPackage.Literals.EMPLOYEE_SKILL;
	}
	...
	public void setLevel(int newLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcpPrimerPackage.EMPLOYEE_SKILL__LEVEL, oldLevel, level));
	}
	...
	public Skill getSkill() {
		if (skill != null && skill.eIsProxy()) {
			...
			if (skill != oldSkill) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcpPrimerPackage.EMPLOYEE_SKILL__SKILL, oldSkill, skill));
			}
		}
		return skill;
	}
	...
	public void setSkill(Skill newSkill) {
		...
		skill = newSkill;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcpPrimerPackage.EMPLOYEE_SKILL__SKILL, oldSkill, skill));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcpPrimerPackage.EMPLOYEE_SKILL__LEVEL:
				return getLevel();
			case EcpPrimerPackage.EMPLOYEE_SKILL__SKILL:
