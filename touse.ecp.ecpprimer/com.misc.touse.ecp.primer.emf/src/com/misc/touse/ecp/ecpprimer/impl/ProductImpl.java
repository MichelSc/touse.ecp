...
import com.misc.touse.ecp.ecpprimer.Machine;
 ...
 * </p>
 * <ul>
 *   <li>{@link com.misc.touse.ecp.ecpprimer.impl.ProductImpl#getRequiredSkills <em>Required Skills</em>}</li>
 *   <li>{@link com.misc.touse.ecp.ecpprimer.impl.ProductImpl#getRequiredMachines <em>Required Machines</em>}</li>
 *   <li>{@link com.misc.touse.ecp.ecpprimer.impl.ProductImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.misc.touse.ecp.ecpprimer.impl.ProductImpl#getProductionHours <em>Production Hours</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductImpl extends MinimalEObjectImpl.Container implements Product {
	...
	protected EClass eStaticClass() {
		return EcpPrimerPackage.Literals.PRODUCT;
	}
	...
	public EList<ProductSkill> getRequiredSkills() {
		if (requiredSkills == null) {
			requiredSkills = new EObjectContainmentEList<ProductSkill>(ProductSkill.class, this, EcpPrimerPackage.PRODUCT__REQUIRED_SKILLS);
		}
	...
	public EList<Machine> getRequiredMachines() {
		if (requiredMachines == null) {
			requiredMachines = new EObjectResolvingEList<Machine>(Machine.class, this, EcpPrimerPackage.PRODUCT__REQUIRED_MACHINES);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcpPrimerPackage.PRODUCT__NAME, oldName, name));
	}
	...
	public void setProductionHours(float newProductionHours) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcpPrimerPackage.PRODUCT__PRODUCTION_HOURS, oldProductionHours, productionHours));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EcpPrimerPackage.PRODUCT__REQUIRED_SKILLS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EcpPrimerPackage.PRODUCT__REQUIRED_MACHINES:
				return getRequiredMachines();
			case EcpPrimerPackage.PRODUCT__NAME:
				return getName();
			case EcpPrimerPackage.PRODUCT__PRODUCTION_HOURS:
