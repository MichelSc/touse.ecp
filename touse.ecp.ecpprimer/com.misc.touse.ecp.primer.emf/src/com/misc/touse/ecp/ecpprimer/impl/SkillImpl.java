 ...
 * </p>
 * <ul>
 *   <li>{@link com.misc.touse.ecp.ecpprimer.impl.SkillImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SkillImpl extends MinimalEObjectImpl.Container implements Skill {
	...
	protected EClass eStaticClass() {
		return EcpPrimerPackage.Literals.SKILL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcpPrimerPackage.SKILL__NAME, oldName, name));
	}
