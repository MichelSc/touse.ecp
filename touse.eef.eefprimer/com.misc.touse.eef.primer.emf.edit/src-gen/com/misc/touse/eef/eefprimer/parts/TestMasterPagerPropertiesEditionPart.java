 ...
 * 
 */
public interface TestMasterPagerPropertiesEditionPart {

		/**
		 * @return the TestEditorStandardPage SubView
		 * 
		 */
			public IPropertiesEditionPart getTestEditorStandardPageSubView();
