...
public class ProductPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ProductPropertiesEditionPart {
		...
		composer = new PartComposer(productStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == EefprimerViewsRepository.Product.Properties.requiredSkills) {
					return createRequiredSkillsAdvancedTableComposition(parent);
				}
				if (key == EefprimerViewsRepository.Product.Properties.requiredMachines) {
					return createRequiredMachinesAdvancedReferencesTable(parent);
				}
				...
				if (key == EefprimerViewsRepository.Product.Properties.productionHours) {
					return createProductionHoursText(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(EefprimerMessages.ProductPropertiesEditionPart_PropertiesGroupLabel);
	 ...
	 * 
	 */
	protected Composite createRequiredSkillsAdvancedTableComposition(Composite parent) {
		this.requiredSkills = new ReferencesTable(getDescription(EefprimerViewsRepository.Product.Properties.requiredSkills, EefprimerMessages.ProductPropertiesEditionPart_RequiredSkillsLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProductPropertiesEditionPartImpl.this, EefprimerViewsRepository.Product.Properties.requiredSkills, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				requiredSkills.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProductPropertiesEditionPartImpl.this, EefprimerViewsRepository.Product.Properties.requiredSkills, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				requiredSkills.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProductPropertiesEditionPartImpl.this, EefprimerViewsRepository.Product.Properties.requiredSkills, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				requiredSkills.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProductPropertiesEditionPartImpl.this, EefprimerViewsRepository.Product.Properties.requiredSkills, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				requiredSkills.refresh();
			}
		...
		this.requiredSkills.setHelpText(propertiesEditionComponent.getHelpContent(EefprimerViewsRepository.Product.Properties.requiredSkills, EefprimerViewsRepository.SWT_KIND));
		this.requiredSkills.createControls(parent);
		this.requiredSkills.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProductPropertiesEditionPartImpl.this, EefprimerViewsRepository.Product.Properties.requiredSkills, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createRequiredSkillsAdvancedTableComposition
	 ...
	 * 
	 */
	protected Composite createRequiredMachinesAdvancedReferencesTable(Composite parent) {
		String label = getDescription(EefprimerViewsRepository.Product.Properties.requiredMachines, EefprimerMessages.ProductPropertiesEditionPart_RequiredMachinesLabel);		 
		this.requiredMachines = new ReferencesTable(label, new ReferencesTableListener() {
		...
		this.requiredMachines.setHelpText(propertiesEditionComponent.getHelpContent(EefprimerViewsRepository.Product.Properties.requiredMachines, EefprimerViewsRepository.SWT_KIND));
		this.requiredMachines.createControls(parent);
		this.requiredMachines.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProductPropertiesEditionPartImpl.this, EefprimerViewsRepository.Product.Properties.requiredMachines, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"RequiredMachines", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProductPropertiesEditionPartImpl.this, EefprimerViewsRepository.Product.Properties.requiredMachines,
	...
	protected void moveRequiredMachines(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProductPropertiesEditionPartImpl.this, EefprimerViewsRepository.Product.Properties.requiredMachines, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		requiredMachines.refresh();
	}
	...
	protected void removeFromRequiredMachines(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProductPropertiesEditionPartImpl.this, EefprimerViewsRepository.Product.Properties.requiredMachines, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		requiredMachines.refresh();
	}
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProductPropertiesEditionPartImpl.this, EefprimerViewsRepository.Product.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EefprimerViewsRepository.Product.Properties.name, EefprimerViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createProductionHoursText(Composite parent) {
		...
		productionHours = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		productionHours.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProductPropertiesEditionPartImpl.this, EefprimerViewsRepository.Product.Properties.productionHours, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, productionHours.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EefprimerViewsRepository.Product.Properties.productionHours, EefprimerViewsRepository.SWT_KIND), null); //$NON-NLS-1$
