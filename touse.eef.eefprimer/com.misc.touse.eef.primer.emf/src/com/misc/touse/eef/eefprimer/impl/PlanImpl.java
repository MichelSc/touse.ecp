 ...
 * </p>
 * <ul>
 *   <li>{@link com.misc.touse.eef.eefprimer.impl.PlanImpl#getID <em>ID</em>}</li>
 *   <li>{@link com.misc.touse.eef.eefprimer.impl.PlanImpl#getOrders <em>Orders</em>}</li>
 *   <li>{@link com.misc.touse.eef.eefprimer.impl.PlanImpl#getResources <em>Resources</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlanImpl extends MinimalEObjectImpl.Container implements Plan {
	...
	protected EClass eStaticClass() {
		return EefPrimerPackage.Literals.PLAN;
	}
	...
	public void setID(int newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EefPrimerPackage.PLAN__ID, oldID, id));
	}
	...
	public EList<Order> getOrders() {
		if (orders == null) {
			orders = new EObjectContainmentEList<Order>(Order.class, this, EefPrimerPackage.PLAN__ORDERS);
		}
		return orders;
	}
	...
	public EList<ResourceAvailable> getResources() {
		if (resources == null) {
			resources = new EObjectContainmentEList<ResourceAvailable>(ResourceAvailable.class, this, EefPrimerPackage.PLAN__RESOURCES);
		}
		return resources;
	}
